...
class YellowJapanese {
    ...
    public function onLoad($yellow) {
        ...
        $this->yellow->language->setDefaults(array(
            ...
            "AudioDescription: HTML5 オーディオプレーヤー。",
            ...
            "CoreDatePast: 今日, 昨日, @x 日前, 1ヶ月前, @x ヶ月前, 1年前, @x 年前, @x 前",
            "CoreDateFuture: まもなく, 明日, @x 日以内, １ヶ月以内, @x ヶ月以内, 1年以内, @x 年以内, @x 後",
            ...
            "CsvDescription: CSV ファイルパーサー。",
            "CzechDescription: チェコ語です。",
            "DailyDescription: 曜日別で表示します。",
            ...
            "PodcastDescription: ポッドキャストの公開用に最適化された Web フィード機能を追加します。",
            ...
            "RadiobossDescription: RadioBoss Cloud 用のウィジェットです。",
            "RandomDescription: ランダムにページを表示します。",
            "ReadingtimeDescription: コンテンツの推定読了時間を表示します。",
            "RedirectDescription: ほかのページへリダイレクトする機能を追加します。",
